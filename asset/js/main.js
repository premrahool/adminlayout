    ...
    $(function () {
      ...
      //  $('.popovers').popover();
                ...
                $(toggleBtn).on('click', function (e) {
                    ...
                    if ($(window).width() > (767)) {
                        if ($("body").hasClass('sidebar-collapse')) {
                            $("body").removeClass('sidebar-collapse').addClass('expand-collapse').trigger('expanded.pushMenu');
                            //alert('remove');
                            Cookies.set('name', '');
                        } else {
                            $("body").removeClass('expand-collapse').addClass('sidebar-collapse').trigger('collapsed.pushMenu');
        ...
        $(function () {
            ...
            //$('.treeview.sub a').each(function () {
            //    if ($(this).prop('href') == window.location.href) {
            //        $('.treeview-menu li').removeClass('sub-menu-active');
        ...
        $(function () {
            ...
            if (path === "/Admin/Dashboard") {
                $('.treeview:first-child').addClass('menu-active');
            }
            ...
            $('.treeview ul li a ').each(function () {
                ...
                var href = $(this).attr('href');
                if (path.substring(0, href.length) === href) {
                    $(this).parent().parent().parent().addClass('sub-active');
                    $(this).parent().addClass('sub-menu-active');
